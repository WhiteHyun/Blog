  ...
  return (
    <div className={className}>
      ...
      <div className="rounded-2xl bg-white dark:bg-zinc-700 w-full md:p-4 lg:p-4 mb-9">
        <div className="relative w-full after:content-[''] after:block after:pb-[100%] bg-transparent rounded-2xl overflow-hidden dark:hidden">
          <Image src={CONFIG.profile.image} layout="fill" alt="" />
        </div>
        <div className="relative w-full after:content-[''] after:block after:pb-[100%] bg-transparent rounded-2xl overflow-hidden hidden dark:block">
          <Image src={CONFIG.profile.imageDark} layout="fill" alt="" />
        </div>
